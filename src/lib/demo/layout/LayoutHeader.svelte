...
<div class='be-header'>
	...
	<div class='nav'>
		...
		<div class='tabs'>
			...
			<div data-theme='dark' class='item moon' class:active={active==='dark'} on:click={() => changeTheme('dark')}>
				<svg width='20' height='20' viewBox='0 0 20 20' fill='none' xmlns='http://www.w3.org/2000/svg'>
					<path fill='currentColor'
...
<style lang='scss'>
  .be-header {
    ...
    .nav {
      ...
      a {
        padding: 20px;display: block;line-height: 20px;
        color: var(--text-primary);

        &:hover {
          background: var(--bg-color-container-select)
        }
