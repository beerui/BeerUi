...
<div class='be-header'>
	...
	<div class='nav'>
		...
		<a rel='noreferrer' target='_blank' href='https://github.com/beerui/BeerUi/blob/main/CHANGELOG.md'>更新日志</a>
		<a class:active={menu === '/others'} href='/others'>其它</a>
		<div class='tabs'>
			<div data-theme='light' class='item sun' class:active={active==='light'}
			...
			<div data-theme='dark' class='item moon' class:active={active==='dark'}
